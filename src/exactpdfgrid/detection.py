...
def _morpho_mask(
    ...
    return cv2.morphologyEx(binary, cv2.MORPH_OPEN, kernel, iterations=morph_open_iterations)
...
def build_cell_grid(
    ...
    """
    Step 3 - purely mathematical cell detection. See module docstring for rules.
